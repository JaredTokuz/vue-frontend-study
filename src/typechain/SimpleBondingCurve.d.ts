...
interface SimpleBondingCurveInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "LogTrade(string,uint256,uint256)": EventFragment;
...
export class SimpleBondingCurve extends BaseContract {
  ...
  interface: SimpleBondingCurveInterface;
  ...
  callStatic: {
    ...
    sell(sellAmount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    ...
    "LogTrade(string,uint256,uint256)"(
      side?: null,
      weiAmt?: null,
      erc20Amt?: null
    ): TypedEventFilter<
      [string, BigNumber, BigNumber],
      { side: string; weiAmt: BigNumber; erc20Amt: BigNumber }
    >;
