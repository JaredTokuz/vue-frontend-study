<template>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-56 mx-auto">
      ...
      >
        <div class="h-14 cursor-pointer active:pt-1">
          <div
            class="rounded-lg text-center pr-10 py-2 bg-green-100 hover:bg-green-200"
          >
            <div
              :class="[
                'text-green-800',
        ...
        <div class="h-14 cursor-pointer active:pt-1">
          <div
            class="rounded-lg text-center pl-3 py-2.5 bg-red-100 hover:bg-red-200"
          >
            <div
              :class="[
                ' text-red-800',
