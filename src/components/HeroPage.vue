              ...
              <div>
                ...
                >
                  <span
                    ...
                    >curious?</span
                  >
                  <span class="ml-4 text-sm">see the src 👀</span>
                  <ChevronRightIcon
                ...
                >
                  <span class="md:block">Interactive Graph Dapp</span>
                  {{ " " }}
                  <span class="text-indigo-400 md:block"
                    >deployed on Rinkeby</span
                  >
                </h1>
                <p
                  class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl"
                >
                  This project tracks all trading activity of a bonding curve
                  smart contract. Made with hardhat, solidity, the graph, urql,
                  vue and apexcharts. The application code base was hosted on
                  (decentralized github). This app was served to you using IPFS.
                </p>
              </div>
            </div>
